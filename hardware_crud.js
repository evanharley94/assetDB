...
function save_row(serial_no)
{
 ...
 ({
  type:'post',
  url:'hardware_modify_records.php',
  data:{
   edit_row:'edit_row',
   id:serial_no,
   vendor_val:vendor,
...
{
	var x = confirm("Are you sure you want to delete? All Maintenance, Warranty & useage records will also be removed for this asset!"); //if user confirms delete, then delete
    if (x){
...
//**************************************
//edit hardware table usage and save to DB using ajax
